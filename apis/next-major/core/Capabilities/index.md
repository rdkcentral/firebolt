...
Version Capabilities 1.8.0-next-major.2
...
| ------------ | ------------ | -------- | ---------------------------------------------------------------------- |
| `capability` | `Capability` | true     | <br/>pattern: ^xrn:firebolt:capability:([a-z0-9\-]+)((:[a-z0-9\-]+)?)$ |
...
| ------------ | ---------------- | -------- | ---------------------------------------------------------------------- |
| `capability` | `Capability`     | true     | <br/>pattern: ^xrn:firebolt:capability:([a-z0-9\-]+)((:[a-z0-9\-]+)?)$ |
| `value`      | `CapabilityInfo` | false    | Provides the capability info.                                          |
...
let listenerId = await Capabilities.listen('available', (result) => {
  console.log(result)
})
```
...
| Param        | Type             | Required | Description                                                            |
| ------------ | ---------------- | -------- | ---------------------------------------------------------------------- |
| `role`       | `Role`           | true     | <br/>values: `'use' \| 'manage' \| 'provide'`                          |
| `capability` | `Capability`     | true     | <br/>pattern: ^xrn:firebolt:capability:([a-z0-9\-]+)((:[a-z0-9\-]+)?)$ |
| `value`      | `CapabilityInfo` | false    | Provides the capability info.                                          |
...
let listenerId = await Capabilities.listen('granted', (result) => {
  console.log(result)
})
```
...
let listenerId = await Capabilities.listen('revoked', (result) => {
  console.log(result)
})
```
...
let listenerId = await Capabilities.listen('unavailable', (result) => {
  console.log(result)
})
```
