...
Version SecondScreen 1.8.0-next-major.2
...
let listenerId = await SecondScreen.listen('friendlyNameChanged', (result) => {
  console.log(result)
})
```
...
| Param               | Type                | Required | Description |
| ------------------- | ------------------- | -------- | ----------- |
| `closeRequestEvent` | `SecondScreenEvent` | false    |             |
...
let listenerId = await SecondScreen.listen('closeRequest', (result) => {
  console.log(result)
})
```
...
| Param                | Type                | Required | Description                                                                                       |
| -------------------- | ------------------- | -------- | ------------------------------------------------------------------------------------------------- |
| `launchRequestEvent` | `SecondScreenEvent` | false    | Dispatched when a second screen device on the local network has requested this app to be launched |
...
let listenerId = await SecondScreen.listen('launchRequest', (result) => {
  console.log(result)
})
```
