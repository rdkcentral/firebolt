...
Version Accessibility 1.8.0-next-major.2
...
let listenerId = await Accessibility.listen(
...
| Param                    | Type                     | Required | Description                  |
| ------------------------ | ------------------------ | -------- | ---------------------------- |
| `closedCaptionsSettings` | `ClosedCaptionsSettings` | false    | the closed captions settings |
...
| Param      | Type                    | Required | Description                 |
| ---------- | ----------------------- | -------- | --------------------------- |
| `settings` | `VoiceGuidanceSettings` | false    | the voice guidance settings |
