...
Version Lifecycle 1.8.0-next-major.2
...
| -------- | ------------- | -------- | -------------------------------------------------------------------------------------------------------------- |
| `reason` | `CloseReason` | true     | The reason the app is requesting to be closed <br/>values: `'remoteButton' \| 'userExit' \| 'done' \| 'error'` |
...
let listenerId = await Lifecycle.listen('background', (result) => {
  console.log(result)
})
```
...
let listenerId = await Lifecycle.listen('foreground', (result) => {
  console.log(result)
})
```
...
let listenerId = await Lifecycle.listen('inactive', (result) => {
  console.log(result)
})
```
...
let listenerId = await Lifecycle.listen('suspended', (result) => {
  console.log(result)
})
```
...
let listenerId = await Lifecycle.listen('unloading', (result) => {
  console.log(result)
})
```
