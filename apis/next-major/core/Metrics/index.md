...
Version Metrics 1.8.0-next-major.4
...
| `agePolicy`  | [`Policies.AgePolicy`](../Policies/schemas/#AgePolicy) | false    | The age policy to associate with the metrics event. The age policy describes the age group to which content is directed.                    |
...
```typescript
function page(pageId: string, agePolicy: Policies.AgePolicy): Promise<boolean>
```
