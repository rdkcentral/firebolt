...
Version Privacy 1.8.0-next-major.4
...
- [Methods](#methods)
  ...
  - [settings](#settings)
- [Events](#events)
  - [onAllowACRCollectionChanged](#onallowacrcollectionchanged)
  - [onAllowAppContentAdTargetingChanged](#onallowappcontentadtargetingchanged)
  - [onAllowCameraAnalyticsChanged](#onallowcameraanalyticschanged)
  - [onAllowPersonalizationChanged](#onallowpersonalizationchanged)
  - [onAllowPrimaryBrowseAdTargetingChanged](#onallowprimarybrowseadtargetingchanged)
  - [onAllowPrimaryContentAdTargetingChanged](#onallowprimarycontentadtargetingchanged)
  - [onAllowProductAnalyticsChanged](#onallowproductanalyticschanged)
  - [onAllowRemoteDiagnosticsChanged](#onallowremotediagnosticschanged)
  - [onAllowResumePointsChanged](#onallowresumepointschanged)
  - [onAllowUnentitledPersonalizationChanged](#onallowunentitledpersonalizationchanged)
  - [onAllowUnentitledResumePointsChanged](#onallowunentitledresumepointschanged)
  - [onAllowWatchHistoryChanged](#onallowwatchhistorychanged)
...
```typescript
function allowACRCollection(callback: (allow) => boolean): Promise<number>
```
...
let listenerId = await allowACRCollection((result) => {
  console.log(result)
})
```
...
let listenerId = await allowAppContentAdTargeting((result) => {
  console.log(result)
})
```
...
```typescript
function allowCameraAnalytics(callback: (allow) => boolean): Promise<number>
```
...
let listenerId = await allowCameraAnalytics((result) => {
  console.log(result)
})
```
...
```typescript
function allowPersonalization(callback: (allow) => boolean): Promise<number>
```
...
let listenerId = await allowPersonalization((result) => {
  console.log(result)
})
```
...
let listenerId = await allowPrimaryBrowseAdTargeting((result) => {
  console.log(result)
})
```
...
let listenerId = await allowPrimaryContentAdTargeting((result) => {
  console.log(result)
})
```
...
```typescript
function allowProductAnalytics(callback: (allow) => boolean): Promise<number>
```
...
let listenerId = await allowProductAnalytics((result) => {
  console.log(result)
})
```
...
```typescript
function allowRemoteDiagnostics(callback: (allow) => boolean): Promise<number>
```
...
let listenerId = await allowRemoteDiagnostics((result) => {
  console.log(result)
})
```
...
```typescript
function allowResumePoints(callback: (allow) => boolean): Promise<number>
```
...
let listenerId = await allowResumePoints((result) => {
  console.log(result)
})
```
...
let listenerId = await allowUnentitledPersonalization((result) => {
  console.log(result)
})
```
...
let listenerId = await allowUnentitledResumePoints((result) => {
  console.log(result)
})
```
...
```typescript
function allowWatchHistory(callback: (allow) => boolean): Promise<number>
```
...
let listenerId = await allowWatchHistory((result) => {
  console.log(result)
})
```
