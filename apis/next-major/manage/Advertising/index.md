...
Version Advertising 1.8.0-next-major.2
...
- [Types](#types)
  ...
  - [SkipRestriction](#skiprestriction-1)
  - [Role](#role)
...
| ------- | ----------------- | -------- | ------------------------------------------------------------ |
| `value` | `SkipRestriction` | true     | <br/>values: `'none' \| 'adsUnwatched' \| 'adsAll' \| 'all'` |
...
| Param    | Type              | Required | Description                                                  |
| -------- | ----------------- | -------- | ------------------------------------------------------------ |
| `result` | `SkipRestriction` | false    | <br/>values: `'none' \| 'adsUnwatched' \| 'adsAll' \| 'all'` |
...
let listenerId = await Advertising.listen(
...
let listenerId = await Advertising.listen('skipRestrictionChanged', result => {
  console.log(result)
})
````
