...
Version Advertising 1.8.0-next-major.3
...
- [Events](#events)
  - [onSkipRestrictionChanged](#onskiprestrictionchanged)
...
```typescript
function skipRestriction(callback: (result) => SkipRestriction): Promise<number>
```

| Param    | Type                                                         | Required | Description                                                  |
| -------- | ------------------------------------------------------------ | -------- | ------------------------------------------------------------ |
| `result` | [`SkipRestriction`](../Advertising/schemas/#SkipRestriction) | false    | <br/>values: `'none' \| 'adsUnwatched' \| 'adsAll' \| 'all'` |
...
let listenerId = await skipRestriction((result) => {
  console.log(result)
})
```
