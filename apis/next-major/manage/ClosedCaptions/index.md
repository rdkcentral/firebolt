...
Version ClosedCaptions 1.8.0-next-major.3
...
- [Events](#events)
  ...
  - [onFontEdgeChanged](#onfontedgechanged)
  - [onFontEdgeColorChanged](#onfontedgecolorchanged)
  - [onFontFamilyChanged](#onfontfamilychanged)
  - [onFontOpacityChanged](#onfontopacitychanged)
  - [onFontSizeChanged](#onfontsizechanged)
  - [onPreferredLanguagesChanged](#onpreferredlanguageschanged)
  - [onTextAlignChanged](#ontextalignchanged)
  - [onTextAlignVerticalChanged](#ontextalignverticalchanged)
  - [onWindowColorChanged](#onwindowcolorchanged)
  - [onWindowOpacityChanged](#onwindowopacitychanged)
...
```typescript
function backgroundColor(callback: (color) => string): Promise<number>
```
...
let listenerId = await backgroundColor((result) => {
  console.log(result)
})
```
...
```typescript
function backgroundOpacity(callback: (opacity) => number): Promise<number>
```
...
let listenerId = await backgroundOpacity((result) => {
  console.log(result)
})
```
...
```typescript
function fontColor(callback: (color) => string): Promise<number>
```
...
let listenerId = await fontColor((result) => {
  console.log(result)
})
```
...
```typescript
function fontEdge(callback: (edge) => string): Promise<number>
```
...
let listenerId = await fontEdge((result) => {
  console.log(result)
})
```
...
```typescript
function fontEdgeColor(callback: (color) => string): Promise<number>
```
...
let listenerId = await fontEdgeColor((result) => {
  console.log(result)
})
```
...
```typescript
function fontFamily(callback: (family) => string): Promise<number>
```
...
let listenerId = await fontFamily((result) => {
  console.log(result)
})
```
...
```typescript
function fontOpacity(callback: (opacity) => number): Promise<number>
```
...
let listenerId = await fontOpacity((result) => {
  console.log(result)
})
```
...
```typescript
function fontSize(callback: (size) => number): Promise<number>
```
...
let listenerId = await fontSize((result) => {
  console.log(result)
})
```
...
```typescript
function preferredLanguages(callback: (languages) => string[]): Promise<number>
```
...
let listenerId = await preferredLanguages((result) => {
  console.log(result)
})
```
...
```typescript
function textAlign(callback: (alignment) => string): Promise<number>
```
...
let listenerId = await textAlign((result) => {
  console.log(result)
})
```
...
```typescript
function textAlignVertical(callback: (alignment) => string): Promise<number>
```
...
let listenerId = await textAlignVertical((result) => {
  console.log(result)
})
```
...
```typescript
function windowColor(callback: (color) => string): Promise<number>
```
...
let listenerId = await windowColor((result) => {
  console.log(result)
})
```
...
```typescript
function windowOpacity(callback: (opacity) => number): Promise<number>
```
...
let listenerId = await windowOpacity((result) => {
  console.log(result)
})
```
