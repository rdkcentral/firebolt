...
| Uses |
| ---- |
| [Player.load](./manage/Player/#load)<br/>[Player.play](./manage/Player/#play)<br/>[Player.stop](./manage/Player/#stop)<br/>[Player.setPosition](./manage/Player/#setposition)<br/>[Player.setSpeed](./manage/Player/#setspeed)<br/>[Player.status](./manage/Player/#status)<br/>[Player.progress](./manage/Player/#progress)<br/>[Player.tracks](./manage/Player/#tracks)<br/>[Player.setAudioTrack](./manage/Player/#setaudiotrack)<br/>[Player.setCaptionsTrack](./manage/Player/#setcaptionstrack)<br/>[Player.onStatusChanged](./manage/Player/#statuschanged)<br/>[Player.onProgressChanged](./manage/Player/#progresschanged) |



| Provides |
| -------- |
| [Player.onRequestLoad](./manage/Player/#requestload)<br/>[Player.onRequestPlay](./manage/Player/#requestplay)<br/>[Player.onRequestStop](./manage/Player/#requeststop)<br/>[Player.onRequestStatus](./manage/Player/#requeststatus)<br/>[Player.onRequestProgress](./manage/Player/#requestprogress)<br/>[Player.onRequestSetPosition](./manage/Player/#requestsetposition)<br/>[Player.onRequestSetSpeed](./manage/Player/#requestsetspeed)<br/>[Player.onRequestTracks](./manage/Player/#requesttracks)<br/>[Player.onRequestSetAudioTrack](./manage/Player/#requestsetaudiotrack)<br/>[Player.onRequestSetCaptionsTrack](./manage/Player/#requestsetcaptionstrack)<br/>[Player.provideStatus](./manage/Player/#providestatus)<br/>[Player.provideProgress](./manage/Player/#provideprogress)<br/>[Player.loadResponse](./manage/Player/#loadresponse)<br/>[Player.loadError](./manage/Player/#loaderror)<br/>[Player.playResponse](./manage/Player/#playresponse)<br/>[Player.playError](./manage/Player/#playerror)<br/>[Player.stopResponse](./manage/Player/#stopresponse)<br/>[Player.stopError](./manage/Player/#stoperror)<br/>[Player.statusResponse](./manage/Player/#statusresponse)<br/>[Player.statusError](./manage/Player/#statuserror)<br/>[Player.progressResponse](./manage/Player/#progressresponse)<br/>[Player.progressError](./manage/Player/#progresserror)<br/>[Player.setPositionResponse](./manage/Player/#setpositionresponse)<br/>[Player.setPositionError](./manage/Player/#setpositionerror)<br/>[Player.setSpeedResponse](./manage/Player/#setspeedresponse)<br/>[Player.setSpeedError](./manage/Player/#setspeederror)<br/>[Player.tracksResponse](./manage/Player/#tracksresponse)<br/>[Player.tracksError](./manage/Player/#trackserror)<br/>[Player.setAudioTrackResponse](./manage/Player/#setaudiotrackresponse)<br/>[Player.setAudioTrackError](./manage/Player/#setaudiotrackerror)<br/>[Player.setCaptionsTrackResponse](./manage/Player/#setcaptionstrackresponse)<br/>[Player.setCaptionsTrackError](./manage/Player/#setcaptionstrackerror) |
...
| Uses |
| ---- |
| [StreamingPlayer.create](./manage/StreamingPlayer/#create) |



| Provides |
| -------- |
| [StreamingPlayer.onRequestCreate](./manage/StreamingPlayer/#requestcreate)<br/>[StreamingPlayer.createResponse](./manage/StreamingPlayer/#createresponse)<br/>[StreamingPlayer.createError](./manage/StreamingPlayer/#createerror) |
