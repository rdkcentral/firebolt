...
| `xrn:firebolt:capability:advertising:configuration` | **COULD** | <details><summary>5</summary>[Advertising.config](./core/Advertising/#config)<br/>[Advertising.policy](./core/Advertising/#policy)<br/>[Advertising.deviceAttributes](./core/Advertising/#deviceattributes)<br/>[Advertising.appBundleId](./core/Advertising/#appbundleid)<br/>[Advertising.onPolicyChanged](./core/Advertising/#policychanged)</details> |  | <details><summary>3</summary>[Advertising.skipRestriction](./manage/Advertising/#skiprestriction)<br/>[Advertising.onSkipRestrictionChanged](./manage/Advertising/#skiprestrictionchanged)<br/>[Advertising.setSkipRestriction](./manage/Advertising/#setskiprestriction)</details> |
...
| `xrn:firebolt:capability:metrics:general` | **MUST** | <details><summary>8</summary>[Metrics.ready](./core/Metrics/#ready)<br/>[Metrics.signIn](./core/Metrics/#signin)<br/>[Metrics.signOut](./core/Metrics/#signout)<br/>[Metrics.startContent](./core/Metrics/#startcontent)<br/>[Metrics.stopContent](./core/Metrics/#stopcontent)<br/>[Metrics.page](./core/Metrics/#page)<br/>[Metrics.action](./core/Metrics/#action)<br/>[Metrics.error](./core/Metrics/#error)</details> |  |  |
...
| `xrn:firebolt:capability:privacy:advertising` | **SHOULD** | <details><summary>2</summary>[Advertising.policy](./core/Advertising/#policy)<br/>[Advertising.onPolicyChanged](./core/Advertising/#policychanged)</details> |  |  |
...
| [Advertising.policy](./core/Advertising/#policy) | **SHOULD** | `advertising:configuration`, `privacy:advertising` |  |  |
...
| [Advertising.onPolicyChanged](./core/Advertising/#policychanged) | **SHOULD** | `advertising:configuration`, `privacy:advertising` |  |  |
...
| [SecondScreen.protocols](./core/SecondScreen/#protocols) | **MUST** | `device:info` |  |  |
